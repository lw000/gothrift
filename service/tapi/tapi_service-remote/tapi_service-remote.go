...
var _ = tapi.GoUnusedProtection__

func Usage() {
	fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
	flag.PrintDefaults()
	fmt.Fprintln(os.Stderr, "\nFunctions:")
	fmt.Fprintln(os.Stderr, "  AckLogin login(ReqLogin req)")
	fmt.Fprintln(os.Stderr, "  AckRegist regist(ReqRegist req)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := tapi.NewTapiServiceClient(thrift.NewTStandardClient(iprot, oprot))
